...
hassmat_tama.traffic_ass(emme_modeller, 21, parameters.stopping_criteria_coarse,
                    parameters.aht_mtx_id)
hassmat_tama.traffic_ass(emme_modeller, 22, parameters.stopping_criteria_coarse,
                    parameters.pt_mtx_id)
hassmat_tama.traffic_ass(emme_modeller, 23, parameters.stopping_criteria_coarse,
                    parameters.iht_mtx_id)
...
kevass.bike_ass(emme_modeller, 19, "mf09", "mf386", "mf100", "vdf=70,72", "@fvol_pt")
kevass.bike_ass(emme_modeller, 19, "mf09", "mf386", "mf101", "vdf=73,75", "@fvol_pt")
kevass.bike_ass(emme_modeller, 19, "mf09", "mf386", "mf102", "vdf=76,78", "@fvol_pt")